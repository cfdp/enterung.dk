 ...
 */
function l10n_install_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['#submit'] = array('l10n_install_custom_submit', 'install_configure_form_submit');
}

/**
 * Custom submit handler for the localized install.
 */
function l10n_install_custom_submit($form, &$form_state) {
 ...
 */
function l10n_install_install_tasks($install_state) {
 ...
 */
function l10n_install_install_tasks_alter(&$tasks, $install_state) {
 ...
 */
function l10n_install_import_translation(&$install_state) {
